...
```sh
$ deno install -A devo https://denopkg.com/iamnathanj/devo@v1.3.0/cli.ts
```
...
```ts
// devo.ts
import { task, parallel, series } from "https://denopkg.com/iamnathanj/devo@v1.3.0/mod.ts";
...
```ts
// devo.ts
import { task } from "https://denopkg.com/iamnathanj/devo@v1.3.0/mod.ts";
